  ...
  getDataSectionMovies() {
    switch(this.section().heroType) {
      case 'now-playing':
        ...
        this.homeService.getMovies(EndPointValid.nowPlaying).subscribe(movies => this.movies.set(movies));
        break;
      case 'popular':
        ...
        this.homeService.getMovies(EndPointValid.popular).subscribe(movies => this.movies.set(movies));
        break;
      case 'top-rated':
        ...
        this.homeService.getMovies(EndPointValid.topRated).subscribe(movies => this.movies.set(movies));
        break;
      case 'trending':
        ...
        this.homeService.getMovies(EndPointValid.trending).subscribe(movies => this.movies.set(movies));
        break;
    }
  };
}
