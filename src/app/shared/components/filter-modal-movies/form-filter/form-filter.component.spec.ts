...
import { MockDefaultQueryParamsService, mockQueryParams, MockQueryParamsService, MockTranslatePipe, MockTranslateService, StubRatingComponent } from '@app/testing';
...
describe('FormFilterComponent.', () => {
  ...
  describe('When the component is initialized with default values.', () => {
    beforeEach(() => {
      ...
      .overrideComponent(FormFilterComponent, {
        remove: { imports: [ TranslatePipe, RatingComponent ] },
        add: { imports: [ MockTranslatePipe, StubRatingComponent ] }
      })
      .compileComponents();
