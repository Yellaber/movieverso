...
import { Keyword, MovieCollection, PaginatedMovies, Trailer } from '@interfaces';
import { mockPaginatedMovies, MockUserGeolocationService, mockKeywords, mockTrailers, mockMovieCollection, MockUserGeolocationServiceUndefined } from '@mocks';
...
describe('DetailService', () => {
  ...
  describe('getMovieCollectionById().', () => {
    it('Should fetch movies from API if cache is empty.', () => {
      ...
      let movieCollection: MovieCollection | undefined;
